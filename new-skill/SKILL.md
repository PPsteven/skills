---
name: new-skill
description: This skill guides the process of creating and deploying new skills to the skills repository. Use this skill when creating a new skill or integrating a skill into the deployment system to understand the complete workflow, directory structure, and verification steps.
---

# Skill Deployment Workflow

This skill documents the complete workflow for creating and deploying new skills to the centralized skills repository.
